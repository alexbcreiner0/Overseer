...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/make-model.mp4" type="video/mp4">
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/make-category.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/make-plots.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
![](images/make-demo.png)

This is enough to see our functions. Go ahead and click Save to apply and close the settings. After this, you should be able to find your demo 
listed in the Demos dropdown of the top menu bar. Click load. 
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/load-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
You might have to do some adjusting to see the plots the way they are pictured. This can be done in a variety of ways, see [the controls section](controls-and-keybindings), but my preferred is to *right click* the screen and drag to change the horizontal and vertical magnification. Once you've found a setup you like, you can click View -> Save current axis settings to attach this view as the default when your demo loads, so that you don't have to futz around with the camera so much next time. 
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/make-controls.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/controls-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/animation-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
