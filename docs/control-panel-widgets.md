...
In this section, we will go into detail on all of the things you can build in a control panel. Note that this section is specifically focused on the simulation controls tab of the control panel. For more information on the plot controls tab, see [the section on the anatomy of Overseer section](anatomy).

The control settings tab allows you to edit the controls which you see in the control panel:

![](images/control-settings.png)
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/moving-widgets.mp4" type="video/mp4">
...
![](images/control-panel-wizard.png)
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/wizard-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
![](images/scalar-entry-options.png)
...
The change effect field allows you to specify on a widget-by-widget basis when a parameter should restart the simulation vs when it should send an update message instead. These preferences are only respected when the 'Parameter change response' (located in the toolbar) is set to 'Widgets decide)'. If you are a beginner, it is highly recommended to just leave this field with the default 'Restart' and not worry about it. For more information on live updating, see [here](event-queue-and-live-updating).
...
![](images/matrix-vector-entries-widgets.png)
...
![](images/vector-entry-options.png)
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/random-parameters.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/button-settings.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/shocks-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
![](images/meta-dependency-matrix.png)
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/meta-changes-demo.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
...
![](images/plot-preprocess-setting.png)
...
<div class="video-wrapper">
  <video
    ...
    width="100%"
  >
    <source src="_static/videos/plot-preprocessing.mp4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</div>
```
